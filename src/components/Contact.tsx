...
const Contact: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-primary/90 relative">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <h2 className="text-4xl font-bold mb-6">
              Let's <span className="text-secondary block">Connect</span>
            </h2>
            ...
            <div className="flex flex-col space-y-4 mb-6">
              <div className="flex items-center text-gray-400">
                ...
                <span>rajritik21av@gmail.com</span>
              </div>
              ...
              <div className="flex items-center text-gray-400">
                ...
                <span>Biharsharif, Bihar, India</span>
              </div>
            </div>
            ...
            <div className="flex space-x-4">
              ...
              <motion.a
                whileHover={{ y: -3 }}
                whileTap={{ scale: 0.95 }}
                href="https://www.linkedin.com/in/ritik-ranjan-15913522a/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-secondary transition-colors"
              >
            ...
            <form ref={form} onSubmit={handleSubmit}>
              <div className="mb-6">
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 bg-primary/50 rounded border border-gray-700 focus:border-secondary focus:outline-none focus:ring-1 focus:ring-secondary text-white"
                  placeholder="Name"
                />
              </div>
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  required
                  rows={5}
                  className="w-full px-4 py-3 bg-primary/50 rounded border border-gray-700 focus:border-secondary focus:outline-none focus:ring-1 focus:ring-secondary text-white resize-none"
                  placeholder="Message"
                ></textarea>
              </div>
